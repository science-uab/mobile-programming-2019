...
<html>
  ...
  <body>
    <nav class="navbar navbar-default">
            ...
            <li class="active"><a href="productsadmin.php"><span class="glyphicon glyphicon-th-list"></span> Products<span class="sr-only">(current)</span></a></li>
						<li><a href="cartadmin.php"><span class="glyphicon glyphicon-shopping-cart"></span> Cart</a></li>
            <li><a href="addproduct.php"><span class="glyphicon glyphicon-refresh"></span> Add/Remove Product</a></li>
					</ul>
				</div>
			</div>
		</nav>
    ...
    <?php
      ...
      if ($lista) {
        ...
        echo "<meta http-equiv=\"refresh\" content=\"0.00001; URL='productsadmin.php'\" >";
      }
		?>
                ...
                <?php
                  if (mysqli_num_rows($query) > 0) {
                    while($row = mysqli_fetch_assoc($query)) {
                      ...
                      echo "<td><a href='productsadmin.php?Id_product=".$row['Id_product']."&action=view'>" . "Add to cart" . "</a></td>";
                      echo "</tr>";
                    }
                  }
              }
